...
```bash
# Generate Ruby models from an OpenAPI spec
cdd-ruby from_openapi to_sdk -i spec.json -o src/models

# Generate an OpenAPI spec from your Ruby code
cdd-ruby to_openapi -f src/models -o openapi.json
```
