...
class OpenapiMetadataTest < Minitest::Test
  def test_openapi_metadata
    ...
    assert_match(/# @api_self https:\/\/example.com\/openapi.json/, emitted)
    assert_match(/# @api_jsonSchemaDialect https:\/\/json-schema.org\/draft\/2020-12\/schema/, emitted)
    assert_match(/# @api_server https:\/\/example.com\/api Production server/, emitted)
