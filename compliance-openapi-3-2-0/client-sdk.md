...
| **Info Object (`summary`)** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Short package description in package.json/pom.xml |
...
| **Contact Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Package maintainer info in manifest |
| **Contact Object (`name`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Contact Object (`url`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Contact Object (`email`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **License Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Package license generation |
| **License Object (`name`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **License Object (`identifier`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Package license SPDX field |
...
| **Components Object (`pathItems`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Reusable SDK resource group resolution |
| **Components Object (`mediaTypes`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Reusable payload serialization definitions |
...
| **Path Item Object (`query`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | QUERY HTTP method generation |
| **Path Item Object (`additionalOperations`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Custom HTTP method generation |
...
| **External Documentation Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Rendered into method/class Javadoc or IDE docstrings |
...
| **Request Body Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Typed request payload object/class argument |
...
| **Media Type Object (`itemSchema`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Strong typing for array items in sequential media types |
...
| **Encoding Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | URL-encoding logic for complex queries, multipart builders |
...
| **Responses Object** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Return type branching (Success types vs. Error throwing) |
...
| **Response Object (`summary`)** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Javadoc/Docstring for specific response branches |
...
| **Example Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Mock HTTP client generation & unit test fixtures |
...
| **Tag Object (`parent`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Nested client namespaces (e.g., `client.billing.invoices`) |
| **Tag Object (`kind`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Organizing generated classes by kind |
...
| **Discriminator Object** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Client-side deserialization factories (Polymorphic JSON decoding) |
| **Discriminator Object (`propertyName`)** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Discriminator Object (`mapping`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Discriminator Object (`defaultMapping`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Default fallback for polymorphic deserialization |
| **XML Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | XML DOM mapping / Often skipped if JSON-only |
| **XML Object (`nodeType`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Precise XML DOM mapping controls |
...
| **OAuth Flows Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Helpers for token exchange requests |
...
| **OAuth Flow Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | URL discovery for token exchange |
| **OAuth Flow Object (`authorizationUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flow Object (`deviceAuthorizationUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | SDK method for initiating device flow authentication |
| **OAuth Flow Object (`tokenUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flow Object (`refreshUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flow Object (`scopes`)** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Security Requirement Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Automatic attachment of required auth headers per method |
