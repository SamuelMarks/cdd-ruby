...
| **Contact Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Appended to global help or skipped |
| **Contact Object (`name`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Contact Object (`url`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Contact Object (`email`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **License Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Appended to global help or skipped |
| **License Object (`name`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **License Object (`identifier`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | SPDX license identifier extraction |
...
| **OAuth Flow Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Flow routing logic for CLI login |
| **OAuth Flow Object (`authorizationUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flow Object (`deviceAuthorizationUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Triggers CLI device auth prompt |
| **OAuth Flow Object (`tokenUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flow Object (`refreshUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flow Object (`scopes`)** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Security Requirement Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Asserting required auth exists before command execution |
