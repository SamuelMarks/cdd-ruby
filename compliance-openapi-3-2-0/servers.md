...
| **Info Object (`summary`)** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Global API short summary docstring |
| **Info Object (`description`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Info Object (`termsOfService`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Info Object (`contact`)** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Info Object (`license`)** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Info Object (`version`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Contact Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Included in generated HTML docs/metadata |
| **Contact Object (`name`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Contact Object (`url`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Contact Object (`email`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **License Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Included in generated HTML docs/metadata |
| **License Object (`name`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **License Object (`identifier`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Server metadata / openapi.json generation |
...
| **Server Variable Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Dynamic route prefix validation / Enum injection |
...
| **Components Object (`pathItems`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Reusable router mounting blocks |
| **Components Object (`mediaTypes`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Reusable content negotiation blocks |
| **Paths Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Core router mounting and path mapping |
| **Paths Object (`/{path}`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Path Item Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Grouping endpoints by URI / Route-level parameters |
...
| **Path Item Object (`options`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Path Item Object (`head`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Path Item Object (`patch`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Path Item Object (`trace`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Path Item Object (`query`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | QUERY HTTP method handler binding |
| **Path Item Object (`additionalOperations`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Custom HTTP method handler bindings |
| **Path Item Object (`servers`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Path Item Object (`parameters`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Operation Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Individual Controller/Handler method bindings |
...
| **External Documentation Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Javadoc/Docstring generation or extraction |
...
| **Request Body Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Payload parsing, ORM hydration, and validation limits |
...
| **Media Type Object (`itemSchema`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Validation middleware for sequential payload elements |
...
| **Encoding Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Handling multipart/form-data boundary & URL-encoded arrays |
...
| **Responses Object** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Status code mapping (`200`, `4xx`) & `default` fallback handlers |
| **Responses Object (`default`)** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Responses Object (`HTTP Status Code`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Response Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Outgoing DTO serialization & header formatting |
| **Response Object (`summary`)** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Docstring generation for handler responses |
...
| **Callback Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Async out-of-band webhook dispatchers |
| **Callback Object (`{expression}`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Example Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Generating mock server endpoints / Test fixtures |
...
| **Link Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | HATEOAS / Relation mapping generation for APIs |
...
| **Header Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Setting strongly-typed response headers (e.g. `X-RateLimit`) |
...
| **Tag Object (`parent`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Controller inheritance / nested routers |
| **Tag Object (`kind`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Controller categorization metadata |
| **Reference Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Reference Object (`$ref`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Internal component resolution & circular dependency cycles |
...
| **Discriminator Object** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Polymorphism / Single Table Inheritance ORM parsing |
| **Discriminator Object (`propertyName`)** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Discriminator Object (`mapping`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Discriminator Object (`defaultMapping`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Fallback STI mapping in ORM when missing type |
| **XML Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | XML DOM serialization/deserialization |
| **XML Object (`nodeType`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | XML deserialization binding rules (`attribute`/`element`) |
| **XML Object (`name`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **XML Object (`namespace`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **XML Object (`prefix`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **XML Object (`attribute`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **XML Object (`wrapped`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Security Scheme Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
...
| **Security Scheme Object (`in`)** | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Security Scheme Object (`scheme`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Security Scheme Object (`bearerFormat`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
...
| **OAuth Flows Object** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | Registering endpoints for supported grant types |
| **OAuth Flows Object (`implicit`)** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flows Object (`password`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flows Object (`clientCredentials`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flows Object (`authorizationCode`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flows Object (`deviceAuthorization`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Support for the Device Authorization grant flow |
| **OAuth Flow Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Extracting flow metadata (auth URL, token URL, scopes) |
| **OAuth Flow Object (`authorizationUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flow Object (`deviceAuthorizationUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Routing for issuing device codes |
| **OAuth Flow Object (`tokenUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flow Object (`refreshUrl`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **OAuth Flow Object (`scopes`)** | `[ ]` , `[x]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
| **Security Requirement Object** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | Enforcing endpoint-level combinations (AND/OR auth logic) |
| **Security Requirement Object (`{name}`)** | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[x]` | TODO |
