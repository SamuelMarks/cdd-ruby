...
sdk_dir = File.expand_path('../../cdd-ruby-client-v3-generated-server', __dir__)
server_dir = File.expand_path('../../cdd-ruby-server-v3-generated', __dir__)
...
Dir.chdir(server_dir) do
  ...
  unless system("EPHEMERAL_DB=true bundle exec ruby -e 'Dir.glob(\"tests/**/*_test.rb\").each { |f| require_relative f }'")
    puts 'Failed to run server unit tests for OpenAPI 3'
    exit 1
  end
end
